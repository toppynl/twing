...
runTest({
    description: 'one-word unknown test at parse time',
    environmentOptions: {
        parserOptions: {
            strict: true
        }
    ...
    expectedErrorMessage: 'TwingParsingError: Unknown test "unknown" in "index.twig" at line 1.'
});
...
runTest({
    description: 'two-words unknown test at parse time',
    environmentOptions: {
        parserOptions: {
            strict: true
        }
    ...
    expectedErrorMessage: 'TwingParsingError: Unknown test "un known" in "index.twig" at line 1.'
});
