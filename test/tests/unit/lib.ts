...
tape('library index', ({same, end}) => {
    const expected: Array<string> = [
        ...
        'createConstantNode', 'constantNodeType',
        'createEscapeNode',
        ...
        'createEndsWithNode', 'endsWithNodeType',
        'createHasEveryNode', 'hasEveryNodeType',
        'createHasSomeNode', 'hasSomeNodeType',
        'createIsEqualNode',
