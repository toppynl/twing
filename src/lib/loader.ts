...
export interface TwingLoader {
     ...
     */
    getSourceContext(name: string, from: Source | null): Promise<Source | null>;
     ...
     */
    getCacheKey(name: string, from: Source | null): Promise<string | null>;
     ...
     */
    isFresh(name: string, time: number, from: Source | null): Promise<boolean | null>;
     ...
     */
    exists(name: string, from: Source | null): Promise<boolean>;
     ...
     */
    resolve(name: string, from: Source | null): Promise<string | null>;
}
