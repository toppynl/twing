...
const program = () => {
    ...
    console.log(`Building @toppynl/twing-cache-extra under version ${version}...`);
        ...
        output: [
            {
                ...
                plugins: [
                    createPackageManifestPlugin({
                        ...
                        version,
                        description: "Cache tag for Twing (port of twig/cache-extra)",
                        keywords: ["twing", "twig", "cache", "cache-extra"],
